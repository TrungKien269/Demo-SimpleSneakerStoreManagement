                            ...
                            <ul class="nav navbar-nav navbar-left">
                                <li>
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                        ...
                                        <p class="hidden-lg hidden-md">Bills</p>
                                    </a>
                                </li>
                                <li class="dropdown">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            ...
                            <div class="col-md-12">
                                <table class="table">
                                    <tr>
                                        ...
                                        <th style="font-weight: inherit" scope="col">Supplier</th>
                                        <th style="font-weight: inherit" scope="col">Import day</th>
                                        <th style="font-weight: inherit" scope="col">Detail</th>
                                    </tr>
                                    <c:forEach items="${phieuNhapList}" var="item">
                                    <tr>
                                        <td style="font-weight: lighter">${item.getSerial()}</td>
                                        <td style="font-weight: lighter">${item.getNhacungcap().getTenncc()}</td>
                                        <td style="font-weight: lighter">${item.getNgaynhap()}</td>
                                        <td><button type="button" class="btn btn-info btn-fill"><a href="<c:url value="/billdetail/${item.getSerial()}" />">Detail</a></button></td>
                                    </tr>
                                    </c:forEach>
                                </table>
                            </div>
