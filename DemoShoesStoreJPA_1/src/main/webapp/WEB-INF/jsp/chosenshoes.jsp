                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <form action="/addchitietsize" method="post">
                               <label>SKU</label> <input type="text" class="form-control" name="magiay" value="<c:out value="${giay.getMagiay()}"/>" />
                                <label>Shoes Name</label><input type="text" class="form-control" name="tengiay" value="<c:out value="${giay.getTengiay()}"/>" required/>
                                <label>Size</label>
                        ...
                        <div class="col-md-4">
                            ...
                            <form action="/addgiagiay" method="post">
                                <label>SKU</label><input type="text" class="form-control" name="magiay" value="<c:out value="${giay.getMagiay()}"/>" />
                                <label>Shoes Name</label><input type="text" class="form-control" name="tengiay" value="<c:out value="${giay.getTengiay()}"/>" />
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="tengiay" value="<c:out value="${giay.getTengiay()}"/>" required>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>Shoes ID</label>
                                        <input type="text" class="form-control" name="magiay" value="<c:out value="${giay.getMagiay()}"/>" required/>
                                    </div>
                                </div>
