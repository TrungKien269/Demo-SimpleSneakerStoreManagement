                        ...
                        <form action="/insertbill", method="post">
                            <div class="small-row">
                                <div class="form-group">
                                    <label>Serial Bill</label>
                                    <input type="text" class="form-control" name="serial" value="${serial}"required />
                                </div>
                            </div>
                            <div class="small-row">
                                <div class="form-group">
                                    <label>Suppliers</label>
                                    <select style="width: 100%;height: 90%" name="mancc">
                                        <c:forEach items="${nccList}" var="item">
                                            <option value="<c:out value="${item.getMancc()}"/>"><c:out value="${item.getTenncc()}"/></option>
                                        </c:forEach>
                                    </select>
                            ...
                            <input type="submit" class="btn btn-info btn-fill" value="ADD"/>
                        </form>
                    </div>
                </div>
            </div>
